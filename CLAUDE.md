...
A browser Pac-Man game — a proof-of-concept consumer repo for the `interns`
...
## Licence
- Please add on top of each file comment like /** POC for https://github.com/abi83/interns/ **/
